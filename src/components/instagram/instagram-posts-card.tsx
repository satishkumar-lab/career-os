...
import type { InstagramPost } from "@/components/instagram/types";
...
function PostRow({
  ...
  return (
    ...
    >
      <span className="flex size-9 shrink-0 items-center justify-center rounded-2xl bg-[rgba(225,48,108,0.12)]">
        <Camera className="size-[15px] text-[#e1306c]" />
      </span>
...
export interface InstagramPostsCardProps {
  posts: InstagramPost[];
